...
// Vendored from awtoau/c2rust's c2rust-bitfields crate (upstream:
// immunant/c2rust) for linux-rs#55 — the real Kbuild path needs this
// support crate wired in so c2rust's BitfieldStruct-derived output can
// compile without opaquing, for any struct genuinely used by value.
